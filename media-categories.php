...
define( 'MEDIA_CATEGORIES_VERSION', '1.0.6' );
...
define( 'MEDIA_CATEGORIES_UPDATE_PACKAGE_URL', 'https://cdlib.org/services-groups/webprod/plugins/media-categories/files/media-categories-1.0.6.zip' );
