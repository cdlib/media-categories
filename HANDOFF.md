...
- `media-categories.php`
  - Main plugin header
  - Current plugin version is `0.1.2`
...
- Update metadata is pulled from:
  ...
  - ZIP: `https://satzman.com/plugin-updates/media-categories/media-categories-0.1.2.zip`
...
- Plugin version and stable tag are now `0.1.2`.
