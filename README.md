...
This project is open source under the MIT License. See [LICENSE](https://github.com/cdlib/media-categories/blob/main/LICENSE) for the full text.
...
Contributions are welcome. Please read [CONTRIBUTING.md](https://github.com/cdlib/media-categories/blob/main/CONTRIBUTING.md) before opening a pull request.

## Security

If you discover a security issue, please follow the reporting guidance in [SECURITY.md](https://github.com/cdlib/media-categories/blob/main/SECURITY.md) instead of opening a public issue.

## Code of Conduct

Participation in this project is governed by [CODE_OF_CONDUCT.md](https://github.com/cdlib/media-categories/blob/main/CODE_OF_CONDUCT.md).
